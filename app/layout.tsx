...
export const metadata: Metadata = {
  title: "Interview Buddy - Mock Interview Practice Platform",
  description: "Practice coding interviews with timed sessions, streak tracking, and performance analytics",
};
